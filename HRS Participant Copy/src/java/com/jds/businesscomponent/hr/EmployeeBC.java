...
public class EmployeeBC {
	...
	public EmployeeBC() throws HRSSystemException {
		...
		try {
			...
			e.printStackTrace();
			throw new HRSSystemException("intialize.employee.bc.exception", e
					.getCause());
		}
	...
	public void createEmployee(EmployeeInfo info) throws HRSSystemException,
		...
		if (info.getAccentureDetails() == null)
			throw new HRSLogicalException(
					"accenture.details.required.exception");
	...
	public Collection<EmployeeInfo> searchEmployees(EmployeeInfo info)
		...
		EmployeeInfo data4;
		if (info == null) {
			data3 = empDao.findByAll();
			// throw new HRSLogicalException ("id.required.exception");
			data4 = (EmployeeInfo) data3;
			return (Collection<EmployeeInfo>) data4;
