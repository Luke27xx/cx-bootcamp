...
public class EmpAccentureDetailsDAO implements DataAccessObjectInterface {
	...
	public void create(Connection conn, Object object) throws DAOException {
		...
		AccentureDetails accDet = (AccentureDetails) object;

		if (accDet.getEmployeeNo() == null)
			throw new DAOException("invalid.object.accdao", null,
					DAOException.ERROR, true);
		...
		try {
			...
			AccDetailsAssembler.getPreparedStatement(accDet, stmt);
			stmt.executeUpdate();
	...
	public boolean remove(Connection conn, Object object) throws DAOException {
		// AccentureDetails eInf;
		String query = DAOConstants.EMPACC_DELETE;
		//
	...
	public Object findByPK(Object object) throws DAOException {
		...
		AccentureDetails accDetReturn = null;

		if (!(object instanceof String))
			throw new DAOException("invalid.object.empdao", null,
					DAOException.ERROR, true);
		sqlStmt = "SELECT * FROM empaccenturedetail WHERE empNo = " + object;
		// String pk = (String) object;
		Connection conn = null;

		try {
			log.debug("finding pk AccentureDetails entry");
			...
			if (rs.next()) {
				...
				accDetReturn = AccDetailsAssembler.getInfo(rs);
			}

			rs.close();
			log.debug("found by pk AccentureDetails entry");
	...
	public RowSet find(Object object) throws DAOException {
		...
		String criteria = "enterpriseId like \"%" + accDet.getEnterpriseId()
				+ "%\" AND emailAdd like \"%" + accDet.getEnterpriseAddress()
				+ "%\"";
	...
	public boolean update(Connection conn, Object objSet, Object objWhere)
		...
		AccentureDetails accDetSet = (AccentureDetails) objSet;
		AccentureDetails accDetWhere = (AccentureDetails) objWhere;
		...
		try {
			...
			String set = gen.transformStmt(accDetSet,
					DAOConstants.STMT_TYPE_SET);
			String where = gen.transformStmt(accDetWhere,
