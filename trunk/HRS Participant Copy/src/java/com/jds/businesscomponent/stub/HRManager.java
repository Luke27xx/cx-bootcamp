...
public class HRManager {
	...
	SkillCategoryTest ccc = null;

	private EmployeeInfo EI;
	private Collection sEC;

	private SkillCategoryBC skillCategory;
	...
	public HRManager() throws HRSSystemException {
		...
		eBC = new EmployeeBC();
		skillCategory = new SkillCategoryBC();
		// sBC = new SkillBC();
		// pBC = new ProjectBC();
	}
...
*/		 
	...
	public SkillCategory searchCategory(String id) throws HRSSystemException,
			HRSLogicalException, Exception {
		SkillCategoryBC bc = new SkillCategoryBC();
		SkillCategory skill = (SkillCategory) bc.searchCategory(id);
		// Integer idInt= Integer.parseInt(id);
		System.out.println("my IDS>" + skill.getCategoryName());
