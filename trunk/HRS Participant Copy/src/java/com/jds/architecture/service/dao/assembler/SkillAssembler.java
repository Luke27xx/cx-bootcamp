...
/**
 * @author j.zenkovs
 * SkillAssembler is a class used in populating prepared statement
 * and in retrieving skill from result set.
 */
...
public class SkillAssembler {
	 ...
	 * @param skill Skill value object
	...
	public static void toEmptyStringAllNull(SkillsInformation obj) {
		if(obj.getSkillName() == null) obj.setSkillName(DAOConstants.STR_SPACE);
		if(obj.getSkillDescription() == null) obj.setSkillDescription(DAOConstants.STR_SPACE);
		if(obj.getStatus() == null) obj.setStatus(DAOConstants.STR_SPACE);
	}
}
